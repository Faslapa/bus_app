...
SizedBox(height: 10,),
        ...
        height: 70.0,
          ...
          child: Center(child: Text('10%',style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),)),
        ),),
        InkWell(onTap: (){},child:Container(
                      width: 70.0,
        height: 70.0,
        ...
        height: 70.0,
          ...
          child: Center(child: Text('60%',style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),)),
        ),
        ),
        InkWell(onTap: (){},child:Container(
                      width: 70.0,
        height: 70.0,
          ...
          child: Center(child: Text('90%',style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),)),
        )),
              ],
            ),
          SizedBox(height:40),
